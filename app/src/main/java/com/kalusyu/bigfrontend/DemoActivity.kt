...
import com.kalusyu.bigfrontend.camerax.CameraActivity
import com.kalusyu.bigfrontend.custominput.KeyboardActivity
import com.kalusyu.bigfrontend.h264decode.H264Activity
import com.kalusyu.bigfrontend.mediacodec.MediaCodecActivity
...
class DemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn6.setOnClickListener {
            val test = JniTest()
            test.start(100)
            println("update ${test.update(10f)}")
        }
